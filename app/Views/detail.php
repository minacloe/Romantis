...
<body class="d-flex flex-column vw-100" style="overflow-x: hidden;">
    ...
    <main class="main-content">
        <div class="container-fluid full-width">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="info-value">
                                <a href="<?= base_url('writable/uploads/' . $usulan['berkas_usulan']) ?>" target="_blank" class="file-link">Lihat Berkas Usulan</a>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <label class="info-label">Surat Usulan</label>
                            <div class="info-value">
                                <a href="<?= base_url('writable/uploads/' . $usulan['surat_usulan']) ?>" target="_blank" class="file-link">Lihat Surat Usulan</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Section Disposisi -->
            <?php if ($disposisi && in_array(session()->get('tipe_akun'), ['Admin', 'Super Admin'])): ?>
                <div class="card mb-4 shadow-sm">
                    <div class="card-header text-white" style="background-color: var(--primary);">Informasi Disposisi</div>
                    <div class="card-body">
                        <p><span class="info-label">Nama Disposisi:</span> <div class="info-value"><?= esc($disposisi['nama_admin']) ?></div></p>
                        <p><span class="info-label">Tanggal Disposisi:</span> <div class="info-value"><?= date('d M Y', strtotime($disposisi['tanggal_disposisi'])) ?></div></p>
                        <p><span class="info-label">Jadwal Rapat:</span> <div class="info-value"><?= date('d M Y', strtotime($disposisi['jadwal_rapat'])) ?></div></p>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <?php if (!empty($rekomendasi['surat_rekomendasi'])): ?>
                        <p><span class="info-label">Surat Rekomendasi:</span>
                            <div class="info-value">
                                <a href="<?= base_url('writable/uploads/' . $rekomendasi['surat_rekomendasi']) ?>" target="_blank" class="file-link">
                    ...
                    <?php else: ?>
                        <p><span class="info-label">Surat Rekomendasi:</span>
                            <div class="info-value text-muted">Belum tersedia</div>
                        </p>
                    <?php endif; ?>
