        ...
        <div class="container-fluid main-content px-0 py-3">
            <div class="container-fluid full-width">
                ...
                <div class="row row-equal-height mb-4">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <div class="value text-dark"><?= number_format($totalPengajuan) ?></div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <div class="value text-dark"><?= number_format($totalPrakom) ?></div>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <div class="value text-dark"><?= number_format($totalStatistisi) ?></div>
                                        <div class="label text-dark">Dari Usulan Terakhir</div>
                                    </div>
                                    <div class="p-3 rounded">
                    ...
                    <div class="col-md-6 col-lg-3 mb-3">
                        <div class="card info-card h-100 border-0" style="background-color: #FFF8E1;">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h5 class="text-dark">Persetujuan</h5>
                                        <div class="value text-dark"><?= $persetujuanRate ?>%</div>
                                        <div class="label text-dark">Rate</div>
                                    </div>
                                    <div class="p-3 rounded">
                                        <i class="fas fa-check-circle fa-2x" style="color: #FF8F00;"></i>
                                    </div>
                                </div>
                                <div class="progress mt-2">
                                    <div class="progress-bar" role="progressbar" style="width: <?= $persetujuanRate ?>%; background-color: #FF8F00;" aria-valuenow="<?= $persetujuanRate ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container-fluid px-0">
                    ...
                    <div class="row row-equal-height mb-4">
                        <div class="col-md-6 mb-3">
                            <div class="card h-100 border-0 shadow-sm">
                                <div class="card-header bg-orange-pastel border-0 d-flex justify-content-between align-items-center py-3">
                                    <span class="fw-semibold text-dark">Usulan Statistisi</span>
                                </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="card h-100 border-0 shadow-sm">
                                <div class="card-header bg-orange-pastel border-0 d-flex justify-content-between align-items-center py-3">
                                    <span class="fw-semibold text-dark">Usulan Prakom</span>
                                </div>
                                <div class="card-body pt-0">
                                    <div class="chart-container" style="height: 280px;">
            ...
            <div class="container-fluid full-width">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white border-0 d-flex flex-column flex-md-row justify-content-between align-items-center py-3">
                        ...
                        <form method="GET" action="<?= site_url('dashboard/operator') ?>" class="search-container position-relative">
                                    ...
                                    <?php $no = 1; foreach ($tabelData as $row): ?>
                                        <tr>
                                            ...
                                            <td class="align-middle">                                    
                                                <div class="d-flex justify-content-center">
                                                    <div class="flex-fill text-center px-3">
                                                        <span><?= $row['jumlah_prakom_usulan'] ?></span>
                                                    </div>
                                                    <div class="flex-fill text-center px-3">
                                                        <span><?= $row['jumlah_statistisi_usulan'] ?></span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="align-middle">                                    
                                                <div class="d-flex justify-content-center">
                                                    <div class="flex-fill text-center px-3">
                                                        <span><?= $row['jumlah_prakom_rekomendasi'] ?></span>
                                                    </div>
                                                    <div class="flex-fill text-center px-3">
                                                        <span><?= $row['jumlah_statistisi_rekomendasi'] ?></span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="align-middle">
                                            ...
                                            <td class="align-middle">
                                                <div class="d-flex justify-content-center">
                                                    <!-- Tombol Detail -->
                                                    <button class="btn btn-sm btn-outline-primary rounded" data-bs-toggle="tooltip" title="Lihat Detail"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Data dari PHP - DIUBAH sesuai dengan variabel baru dari controller
    const usulanStatistisi = <?= json_encode($usulanStatistisi) ?>;
    const usulanPrakom = <?= json_encode($usulanPrakom) ?>;
    ...
    // Chart 1 - Usulan Statistisi (menggantikan rekomendasi)
    new Chart(document.getElementById('statistisiChart').getContext('2d'), {
        type: 'bar',
        data: {
            labels: Object.keys(usulanStatistisi).map(key => getLabel(key)),
            datasets: [{
                label: 'Jumlah Usulan',
                data: Object.values(usulanStatistisi),
    ...
    // Chart 2 - Usulan Prakom (menggantikan rekomendasi)
    new Chart(document.getElementById('prakomChart').getContext('2d'), {
        type: 'bar',
        data: {
            labels: Object.keys(usulanPrakom).map(key => getLabel(key)),
            datasets: [{
                label: 'Jumlah Usulan',
                data: Object.values(usulanPrakom),
